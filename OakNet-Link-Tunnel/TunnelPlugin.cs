...
namespace OakNetLink.Tunnel
{
    public class TunnelPlugin : ONLPlugin
    {
        ...
        public override Dictionary<Type, Type> registerPackets()
        {
            ...
            result.Add(typeof(InetAddressRequestPacket), typeof(InetAddressRequestPacketProcessor));
            result.Add(typeof(InetAddressResponsePacket), typeof(InetAddressResponsePacketProcessor));
            result.Add(typeof(TunnelConnectionRequestPacket), typeof(TunnelConnectionRequestPacketProcessor));
            result.Add(typeof(TunnelConnectionResponsePacket), typeof(TunnelConnectionResponsePacketProcessor));
            result.Add(typeof(StrangerTunnelConnectionRequestPacket), typeof(StrangerTunnelConnectionRequestPacketProcessor));
            result.Add(typeof(StrangerTunnelConnectionResponsePacket), typeof(StrangerTunnelConnectionResponsePacketProcessor));
            result.Add(typeof(IPPacketDataPacket), typeof(IPPacketDataPacketProcessor));
