...
/**
 * This class defines the structure of the ChatWindow
 * 
 * @author Fabian Fila
 */
public class ChatWindow extends Window {
	...
	public void initComponent() {
		super.initComponent();
		TextPane chatPane = new TextPane(this, new Vector2i(margin, margin),
				contentSize().add(new Vector2i(-2 * margin, -3 * margin - 20)), outlineSize);
		TextBox chatBox = new TextBox(this, new Vector2i(margin, contentSize().Y - margin - 20),
				new Vector2i(contentSize().X - 3 * margin - 100, 20), outlineSize, "Message");
		Button sendButton = new Button(this, contentSize().add(new Vector2i(-margin - 100, -margin - 20)),
				new Vector2i(100, 20), "Send", outlineSize, new Runnable() {
