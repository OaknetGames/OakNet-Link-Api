...
public class CreateServerWindow extends Window{
	...
	public void initComponent() {
		...
		Button selectWorldButton = new Button(this, leftColPos.copy().add(new Vector2i(rightColSize.X + margin + 1, 0)), leftColSize, "Select World", outlineSize, new Runnable() {
		...
		Label worldInfoLabel=new Label(this, leftColPos.copy(), new Vector2i(contentSize().X - 2*margin, 20), "If no world is selected, a new world will be created.");
		worldInfoLabel.useHighlights=false;
		leftColPos.add(new Vector2i(0, margin+20));
		rightColPos.add(new Vector2i(0, margin+20));
		
		Button startServerButton = new Button(this, leftColPos.copy().add(new Vector2i(((contentSize().X-3*margin)/2) + margin, 0)), new Vector2i((contentSize().X-3*margin)/2, 20), "Start Server", outlineSize, new Runnable() {
