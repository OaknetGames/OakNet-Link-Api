...
/**
 * CONCEPT Packets 
 * Packets need to extend this Class.
 * In order that packets function correctly they need to be instantiated once at initialization.
 * 
 * E.g. You create a HandshakePacket extends UDPPacket
 * You need to create an instance with new HandshakePacket() at init.
 * 
 * Your Packet needs to override two methods:
 * 1. processPacket: this method is called when this Packet is recieved 
 * 2. preparePacket: this method is called when the Packet will be sent
 * 
 * @author Fabian Fila
 */
public abstract class UDPPacket {
	 ...
	 * 
	 * @param params the parameters which are passed to the Packet e.g. a username for a HandshakePacket
