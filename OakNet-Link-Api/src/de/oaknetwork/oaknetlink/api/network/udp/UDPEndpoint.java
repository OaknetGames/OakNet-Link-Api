...
public class UDPEndpoint {
		...
		Thread clientThread = new Thread(new Runnable() {
			...
			public void run() {
				...
				while (connected) {
					...
					// Every 2 seconds
					if ((System.currentTimeMillis() - timeSinceLastPacketIn) % 2000 < 10 && System.currentTimeMillis() - timeSinceLastPacketIn > 2000) {
					...
					// Every 15 seconds
					if ((System.currentTimeMillis() - timeSinceLastPacketIn) % 15000 < 10  && System.currentTimeMillis() - timeSinceLastPacketIn > 15000) {
	...
	/**
	 * Calling this closes the connection to this Endpoint and removes them from the connection list
	 * 
	 * @param reason why the connection was closed
	 */
	public void closeConnection(String reason) {
		//TODO Add Name Here
		Logger.logInfo("YOURNAMEHERE lost connection: " + reason, UDPEndpoint.class);
