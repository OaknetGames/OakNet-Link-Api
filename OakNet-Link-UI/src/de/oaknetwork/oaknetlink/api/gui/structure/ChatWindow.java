...
public class ChatWindow extends Window {
	...
	public void initComponent() {
		super.initComponent();
		new TextPane(this, new Vector2i(margin, margin),
				contentSize().add(new Vector2i(-2 * margin, -3 * margin - 20)), outlineSize);
		new TextBox(this, new Vector2i(margin, contentSize().Y - margin - 20),
				new Vector2i(contentSize().X - 3 * margin - 100, 20), outlineSize, "Message");
		new Button(this, contentSize().add(new Vector2i(-margin - 100, -margin - 20)),
