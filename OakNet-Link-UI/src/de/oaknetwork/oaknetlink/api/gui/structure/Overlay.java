...
public class Overlay extends ColorComponent {
	...
	public void initComponent() {
		...
		closeButton.setBackgroundColorHighlight(Color.GRAY);
		closeButton.setForegroundColorHighlight(Color.WHITE);
		...
		createServerButton.setBackgroundColorHighlight(Color.GRAY);
		createServerButton.setForegroundColorHighlight(Color.WHITE);
		...
		serverListButton.setBackgroundColorHighlight(Color.GRAY);
		serverListButton.setForegroundColorHighlight(Color.WHITE);
		...
		chatButton.setBackgroundColorHighlight(Color.GRAY);
		chatButton.setForegroundColorHighlight(Color.WHITE);
